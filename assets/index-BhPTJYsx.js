const Et={shield:'<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"/>',"shield-check":'<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"/><path d="m9 12 2 2 4-4"/>',"map-pin":'<path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/>',clock:'<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>',activity:'<path d="M3 12h4l3 8 4-16 3 8h4"/>',mountain:'<path d="m8 3 4 8 5-5 5 14H2L8 3Z"/>',tag:'<path d="M12.6 2.7 21 11a2 2 0 0 1 0 2.8l-6.2 6.2a2 2 0 0 1-2.8 0L3.7 11.6A2 2 0 0 1 3 10.2V4a1 1 0 0 1 1-1h6.2a2 2 0 0 1 1.4.7Z"/><circle cx="7.5" cy="7.5" r="1.2"/>',cpu:'<rect x="6" y="6" width="12" height="12" rx="2"/><path d="M9 2v3M15 2v3M9 19v3M15 19v3M2 9h3M2 15h3M19 9h3M19 15h3"/>',scissors:'<circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M20 4 8.1 16M14.5 12.5 20 20M8.1 8 12 12"/>',minimize:'<path d="M4 14h6v6M20 10h-6V4M14 10l7-7M3 21l7-7"/>',merge:'<path d="M8 18v-4a4 4 0 0 1 4-4h8M16 6l4 4-4 4M6 6v12"/>',download:'<path d="M12 3v12M7 11l5 5 5-5M5 21h14"/>',copy:'<rect x="9" y="9" width="11" height="11" rx="2"/><path d="M5 15V5a2 2 0 0 1 2-2h10"/>',upload:'<path d="M12 17V5M7 9l5-5 5 5M5 21h14"/>',x:'<path d="M18 6 6 18M6 6l12 12"/>',check:'<path d="M20 6 9 17l-5-5"/>',"alert-triangle":'<path d="M10.3 3.3 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.3a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/>',eye:'<path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/>',"rotate-ccw":'<path d="M3 12a9 9 0 1 0 3-6.7L3 8M3 3v5h5"/>',"zoom-in":'<circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3M11 8v6M8 11h6"/>',"zoom-out":'<circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3M8 11h6"/>',crosshair:'<circle cx="12" cy="12" r="8"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>',route:'<circle cx="6" cy="19" r="3"/><circle cx="18" cy="5" r="3"/><path d="M9 19h6a4 4 0 0 0 0-8H9a4 4 0 0 1 0-8h0"/>',file:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6"/>',"wifi-off":'<path d="m2 2 20 20M8.5 16.5a5 5 0 0 1 7 0M5 12.9a10 10 0 0 1 3.3-2.2M2 8.8a15 15 0 0 1 4.2-2.6M16.7 10.7A10 10 0 0 1 19 12.9M9 4.2a15 15 0 0 1 12 2.6M12 20h.01"/>'};function h(s,t="size-4"){const n=Et[s];return n?`<svg class="${t}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${n}</svg>`:""}function vt(s,t){if(t==="imperial"){const e=s/1609.344;return`${e.toFixed(e<10?2:1)} mi`}const n=s/1e3;return`${n.toFixed(n<10?2:1)} km`}function j(s,t){return t==="imperial"?`${Math.round(s*3.28084).toLocaleString()} ft`:`${Math.round(s).toLocaleString()} m`}function nt(s){if(s===null)return"—";const t=Math.round(s),n=Math.floor(t/3600),e=Math.floor(t%3600/60),i=t%60;return n>0?`${n}:${String(e).padStart(2,"0")}:${String(i).padStart(2,"0")}`:`${e}:${String(i).padStart(2,"0")}`}function et(s,t){return s===null?"—":t==="imperial"?`${(s*2.236936).toFixed(1)} mph`:`${(s*3.6).toFixed(1)} km/h`}function Pt(s,t){if(s===null||s<=0)return"—";const n=t==="imperial"?1609.344/s:1e3/s,e=Math.floor(n/60),i=Math.round(n%60),o=t==="imperial"?"/mi":"/km";return`${e}:${String(i).padStart(2,"0")} ${o}`}function B(s){return s<1024?`${s} B`:s<1024*1024?`${(s/1024).toFixed(1)} KB`:`${(s/(1024*1024)).toFixed(2)} MB`}function yt(s){return s?`${s.minLat.toFixed(4)}, ${s.minLon.toFixed(4)} → ${s.maxLat.toFixed(4)}, ${s.maxLon.toFixed(4)}`:"—"}function st(s){if(!s)return"—";const t=Date.parse(s);return Number.isFinite(t)?new Date(t).toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):s}function P(s){return Math.round(s).toLocaleString()}function bt(s,t){return s===0?"0%":`${Math.round((1-t/s)*100)}%`}function _(s){return s.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function I(s){if(s.length===0)return{metadata:{},tracks:[],routes:[],waypoints:[],warnings:[]};if(s.length===1)return s[0];const t={metadata:{...s[0].metadata},tracks:[],routes:[],waypoints:[],warnings:[]};for(const n of s)t.tracks.push(...n.tracks),t.routes.push(...n.routes),t.waypoints.push(...n.waypoints),n.warnings.length&&t.warnings.push(...n.warnings);return t}function Mt(s,t){if(s.tracks.length<=1||s.tracks.length===0)return s;const n=s.tracks.flatMap(p=>p.segments);if(n.length===0)return s;const e=t.name??s.tracks.find(p=>p.name)?.name??"Merged track";let i;return i=n,{...s,tracks:[{name:e,segments:i}]}}const K=63710088e-1,Z=Math.PI/180;function W(s,t,n,e){const i=(n-s)*Z,o=(e-t)*Z,p=s*Z,r=n*Z,a=Math.sin(i/2),x=Math.sin(o/2),c=a*a+Math.cos(p)*Math.cos(r)*x*x;return 2*K*Math.asin(Math.min(1,Math.sqrt(c)))}function wt(s,t){return W(s.lat,s.lon,t.lat,t.lon)}function $(s){if(s.length===0)return null;let t=1/0,n=1/0,e=-1/0,i=-1/0;for(const o of s)o.lat<t&&(t=o.lat),o.lat>e&&(e=o.lat),o.lon<n&&(n=o.lon),o.lon>i&&(i=o.lon);return{minLat:t,minLon:n,maxLat:e,maxLon:i}}function R(s,t){return s?t?{minLat:Math.min(s.minLat,t.minLat),minLon:Math.min(s.minLon,t.minLon),maxLat:Math.max(s.maxLat,t.maxLat),maxLon:Math.max(s.maxLon,t.maxLon)}:s:t}function O(s,t,n){const e=t*Z*K*Math.cos(n*Z),i=s*Z*K;return{x:e,y:i}}function it(s,t){const n=Math.pow(10,t);return Math.round(s*n)/n}function Zt(s){return 111320/Math.pow(10,s)}const $t=150,zt=100,Lt=150,St=500;function Ct(s){const t=[],n=e=>{e.length!==0&&(t.push(e[0]),e.length>1&&t.push(e[e.length-1]))};for(const e of s.tracks)for(const i of e.segments)n(i.points);for(const e of s.routes)n(e.points);return t}function ot(s){const t=Ct(s);if(t.length<2)return null;const n=[];for(const p of t){let r=null,a=1/0;for(const x of n){const c=W(p.lat,p.lon,x.lat,x.lon);c<=$t&&c<a&&(r=x,a=c)}r?(r.members.push(p),r.lat=r.members.reduce((x,c)=>x+c.lat,0)/r.members.length,r.lon=r.members.reduce((x,c)=>x+c.lon,0)/r.members.length):n.push({lat:p.lat,lon:p.lon,members:[p]})}let e=n[0];for(const p of n)p.members.length>e.members.length&&(e=p);if(e.members.length<2)return null;const i=Math.max(0,...e.members.map(p=>W(p.lat,p.lon,e.lat,e.lon))),o=Math.min(St,Math.max(Lt,Math.round(i+zt)));return{lat:e.lat,lon:e.lon,radiusM:o}}function F(s,t){return W(s.lat,s.lon,t.lat,t.lon)<=t.radiusM}function pt(s,t){let n=0,e=s.length-1;for(;n<=e&&F(s[n],t);)n++;for(;e>=n&&F(s[e],t);)e--;const i=n<=e?s.slice(n,e+1):[];return{kept:i,removed:s.length-i.length}}function rt(s,t){const n=[];let e=[],i=0;for(const o of s)F(o,t)?(i++,e.length>0&&(n.push(e),e=[])):e.push(o);return e.length>0&&n.push(e),{runs:n,removed:i}}function Rt(s,t,n){let e=0;const i=a=>{const x=[];for(const c of a)if(n==="crop-ends"){const{kept:d,removed:l}=pt(c.points,t);e+=l,d.length>0&&x.push({points:d})}else{const{runs:d,removed:l}=rt(c.points,t);e+=l;for(const g of d)x.push({points:g})}return x},o=s.tracks.map(a=>({...a,segments:i(a.segments)})).filter(a=>a.segments.length>0),p=s.routes.flatMap(a=>{if(n==="crop-ends"){const{kept:d,removed:l}=pt(a.points,t);return e+=l,d.length>0?[{...a,points:d}]:[]}const{runs:x,removed:c}=rt(a.points,t);return e+=c,x.map(d=>({...a,points:d}))}),r=s.waypoints.filter(a=>F(a,t)?(e++,!1):!0);return{doc:{...s,tracks:o,routes:p,waypoints:r},removed:e}}function ht(s,t){return{...s,tracks:s.tracks.map(n=>({...n,segments:n.segments.map(e=>({points:e.points.map(t)}))})),routes:s.routes.map(n=>({...n,points:n.points.map(t)})),waypoints:s.waypoints.map(t)}}function Nt(s,t){let e=ht(s,o=>{const p={lat:o.lat,lon:o.lon};return!t.elevation&&o.ele!==void 0&&(p.ele=o.ele),!t.time&&o.time&&(p.time=o.time),t.names||(o.name&&(p.name=o.name),o.cmt&&(p.cmt=o.cmt),o.desc&&(p.desc=o.desc),o.sym&&(p.sym=o.sym)),t.extensions||(o.ext&&(p.ext=o.ext),o.extRaw&&(p.extRaw=o.extRaw)),p});const i={...e.metadata};return t.time&&delete i.time,t.creator&&(delete i.creator,delete i.author),t.names&&(delete i.name,delete i.desc),e={...e,metadata:i},t.names&&(e={...e,tracks:e.tracks.map(o=>{const p={segments:o.segments};return o.type&&(p.type=o.type),p}),routes:e.routes.map(o=>({points:o.points}))}),e}function Dt(s,t){return ht(s,n=>({...n,lat:it(n.lat,t),lon:it(n.lon,t)}))}function ft(s){let t=!1,n=!1,e=!1,i=s.waypoints.some(r=>r.name||r.cmt||r.desc);const o=r=>{r.time&&(t=!0),r.ele!==void 0&&(e=!0),(r.extRaw||r.ext&&Object.keys(r.ext).length>0)&&(n=!0),(r.name||r.cmt||r.desc||r.sym)&&(i=!0)};for(const r of s.tracks){(r.name||r.desc||r.cmt)&&(i=!0);for(const a of r.segments)for(const x of a.points)o(x)}for(const r of s.routes){(r.name||r.desc)&&(i=!0);for(const a of r.points)o(a)}for(const r of s.waypoints)o(r);s.metadata.time&&(t=!0);const p=!!(s.metadata.creator||s.metadata.author);return{hasTime:t,hasExtensions:n,hasElevation:e,hasNames:i,hasCreator:p}}const At=.5,xt=3;function Ft(s){let t=0,n=0;if(s.length<2)return{gain:t,loss:n};let e=s[0];for(let i=1;i<s.length;i++){const o=s[i],p=o-e;p>xt?(t+=p,e=o):p<-xt&&(n+=-p,e=o)}return{gain:t,loss:n}}function H(s){if(!s)return null;const t=Date.parse(s);return Number.isFinite(t)?t:null}function jt(s){let t=0,n=0,e=null,i=!1,o=0;const p=H(s[0]?.time),r=H(s[s.length-1]?.time);p!==null&&r!==null&&(i=!0,o=Math.max(0,(r-p)/1e3));for(let a=1;a<s.length;a++){const x=s[a-1],c=s[a],d=wt(x,c);t+=d;const l=H(x.time),g=H(c.time);if(l!==null&&g!==null&&g>l){const m=(g-l)/1e3,f=d/m;f>=At&&(n+=m),(e===null||f>e)&&(e=f)}}return{distanceM:t,movingTimeS:n,hasTime:i,spanS:o,maxSpeedMps:e}}function at(s){let t=0,n=0,e=0,i=!1,o=null,p=null,r=null,a=null,x=null,c=null,d=0,l=0;for(const k of s){t+=k.points.length,a=R(a,$(k.points));const M=jt(k.points);n+=M.distanceM,e+=M.movingTimeS,M.hasTime&&(i=!0),M.maxSpeedMps!==null&&(o===null||M.maxSpeedMps>o)&&(o=M.maxSpeedMps);const E=k.points.map(v=>v.ele).filter(v=>v!==void 0),z=Ft(E);d+=z.gain,l+=z.loss;for(const v of E)(p===null||v<p)&&(p=v),(r===null||v>r)&&(r=v);const L=k.points.find(v=>v.time)?.time??null,Y=[...k.points].reverse().find(v=>v.time)?.time??null;L&&(x===null||Date.parse(L)<Date.parse(x))&&(x=L),Y&&(c===null||Date.parse(Y)>Date.parse(c))&&(c=Y)}let g=null;i&&x&&c&&(g=Math.max(0,(Date.parse(c)-Date.parse(x))/1e3));const m=i?e:null,f=g&&g>0?n/g:null;return{pointCount:t,distanceM:n,durationS:g,movingTimeS:m,elevationGainM:d,elevationLossM:l,minEleM:p,maxEleM:r,avgSpeedMps:f,maxSpeedMps:o,startTime:x,endTime:c,bbox:a}}function ct(s){const t=s.tracks.map(i=>at(i.segments)),n=s.tracks.flatMap(i=>i.segments);return{total:at(n),perTrack:t}}const Ht=["magvar","geoidheight","src","sym","type","fix","sat","hdop","vdop","pdop","ageofdgpsdata","dgpsid","speed","course"];function u(s,t){for(const n of Array.from(s.children))if(n.localName===t){const e=n.textContent?.trim();return e&&e.length>0?e:void 0}}function V(s){if(s===void 0)return;const t=Number(s);return Number.isFinite(t)?t:void 0}function Gt(s){const t=new XMLSerializer,n=[];for(const i of Array.from(s.childNodes))n.push(t.serializeToString(i));const e=n.join("").trim();return e.length>0?e:void 0}function q(s,t,n){const e=V(s.getAttribute("lat")??void 0),i=V(s.getAttribute("lon")??void 0);if(e===void 0||i===void 0)return t.push(`Skipped a ${n} with missing/invalid lat/lon.`),null;if(e<-90||e>90||i<-180||i>180)return t.push(`Skipped a ${n} with out-of-range coordinates (${e}, ${i}).`),null;const o={lat:e,lon:i},p=V(u(s,"ele"));p!==void 0&&(o.ele=p);const r=u(s,"time");r&&(o.time=r);const a=u(s,"name");a&&(o.name=a);const x=u(s,"cmt");x&&(o.cmt=x);const c=u(s,"desc");c&&(o.desc=c);const d=u(s,"sym");d&&(o.sym=d);const l={};for(const g of Ht){if(g==="sym")continue;const m=u(s,g);m!==void 0&&(l[g]=m)}for(const g of Array.from(s.children))if(g.localName==="extensions"){const m=Gt(g);m&&(o.extRaw=m)}return Object.keys(l).length>0&&(o.ext=l),o}function Xt(s){const t={},n=s.getAttribute("creator");n&&(t.creator=n);let e;for(const i of Array.from(s.children))if(i.localName==="metadata"){e=i;break}if(e){const i=u(e,"name");i&&(t.name=i);const o=u(e,"desc");o&&(t.desc=o);const p=u(e,"time");p&&(t.time=p);for(const r of Array.from(e.children))if(r.localName==="author"){const a=u(r,"name");a&&(t.author=a)}}else{const i=u(s,"name");i&&(t.name=i);const o=u(s,"desc");o&&(t.desc=o);const p=u(s,"author");p&&(t.author=p);const r=u(s,"time");r&&(t.time=r)}return t}function S(s,t){return Array.from(s.children).filter(n=>n.localName===t)}function ut(s,t){if(!s||s.trim().length===0)return{ok:!1,error:"The file is empty."};let n;try{n=new DOMParser().parseFromString(s,"application/xml")}catch{return{ok:!1,error:"Could not parse the file as XML."}}let e=n.documentElement&&n.documentElement.localName==="gpx"?n.documentElement:null;e||(e=Array.from(n.getElementsByTagName("*")).find(d=>d.localName==="gpx")??null);const i=n.documentElement?.localName==="parsererror"||n.getElementsByTagName("parsererror").length>0;if(!e)return{ok:!1,error:i?"This file is not valid XML, so it could not be read as GPX.":"No <gpx> element found — is this really a GPX file?"};const o=[],p=Xt(e),r=[];for(const d of S(e,"wpt")){const l=q(d,o,"waypoint");l&&r.push(l)}const a=[];for(const d of S(e,"rte")){const l={points:[]},g=u(d,"name");g&&(l.name=g);const m=u(d,"desc");m&&(l.desc=m);for(const f of S(d,"rtept")){const k=q(f,o,"route point");k&&l.points.push(k)}l.points.length>0?a.push(l):o.push("Skipped an empty route.")}const x=[];for(const d of S(e,"trk")){const l={segments:[]},g=u(d,"name");g&&(l.name=g);const m=u(d,"desc");m&&(l.desc=m);const f=u(d,"cmt");f&&(l.cmt=f);const k=u(d,"type");k&&(l.type=k);for(const M of S(d,"trkseg")){const E={points:[]};for(const z of S(M,"trkpt")){const L=q(z,o,"track point");L&&E.points.push(L)}E.points.length>0&&l.segments.push(E)}l.segments.length>0?x.push(l):o.push(`Skipped track "${l.name??"(unnamed)"}" with no valid points.`)}if(x.length===0&&a.length===0&&r.length===0)return{ok:!1,error:"No tracks, routes, or waypoints found in this GPX file."};const c={metadata:p,tracks:x,routes:a,waypoints:r,warnings:o};return t&&(c.sourceName=t),{ok:!0,doc:c}}function G(s){let t=s.waypoints.length;for(const n of s.routes)t+=n.points.length;for(const n of s.tracks)for(const e of n.segments)t+=e.points.length;return t}const Bt="GPX Privacy Cleaner";function T(s){return s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;")}function y(s){return Number.isFinite(s)?Number(s.toFixed(7)).toString():"0"}function Ot(s){const t=n=>!!n.extRaw||n.ext&&Object.keys(n.ext).length>0;return s.waypoints.some(t)||s.routes.some(n=>n.points.some(t))?!0:s.tracks.some(n=>n.segments.some(e=>e.points.some(t)))}const _t=["magvar","geoidheight"],It=["type","fix","sat","hdop","vdop","pdop","ageofdgpsdata","dgpsid","speed","course"];function J(s,t,n){const e=[],i=s.ext??{},o=p=>{i[p]!==void 0&&e.push(`${t}<${p}>${T(i[p])}</${p}>`)};s.ele!==void 0&&e.push(`${t}<ele>${s.ele}</ele>`),s.time&&e.push(`${t}<time>${T(s.time)}</time>`);for(const p of _t)o(p);s.name&&e.push(`${t}<name>${T(s.name)}</name>`),s.cmt&&e.push(`${t}<cmt>${T(s.cmt)}</cmt>`),s.desc&&e.push(`${t}<desc>${T(s.desc)}</desc>`),o("src"),s.sym&&e.push(`${t}<sym>${T(s.sym)}</sym>`);for(const p of It)o(p);return s.extRaw&&e.push(`${t}<extensions>${s.extRaw}</extensions>`),e.join(`
...
`)+`
`}function lt(s){return new TextEncoder().encode(s).length}function Yt(s,t,n){const e=n.x-t.x,i=n.y-t.y,o=e*e+i*i;if(o===0){const x=s.x-t.x,c=s.y-t.y;return Math.hypot(x,c)}let p=((s.x-t.x)*e+(s.y-t.y)*i)/o;p=Math.max(0,Math.min(1,p));const r=t.x+p*e,a=t.y+p*i;return Math.hypot(s.x-r,s.y-a)}function kt(s,t){const n=s.length;if(n<=2||t<=0)return s.slice();let e=0;for(const x of s)e+=x.lat;const i=e/n,o=s.map(x=>O(x.lat,x.lon,i)),p=new Array(n).fill(!1);p[0]=!0,p[n-1]=!0;const r=[[0,n-1]];for(;r.length>0;){const[x,c]=r.pop();if(c-x<2)continue;let d=-1,l=-1;const g=o[x],m=o[c];for(let f=x+1;f<c;f++){const k=Yt(o[f],g,m);k>d&&(d=k,l=f)}d>t&&l!==-1&&(p[l]=!0,r.push([x,l]),r.push([l,c]))}const a=[];for(let x=0;x<n;x++)p[x]&&a.push(s[x]);return a}function Vt(s,t){return{points:kt(s.points,t)}}function qt(s,t){return{...s,segments:s.segments.map(n=>Vt(n,t))}}function Jt(s,t){return t<=0?s:{...s,tracks:s.tracks.map(n=>qt(n,t)),routes:s.routes.map(n=>({...n,points:kt(n.points,t)}))}}function gt(s){let t=0;for(const n of s.tracks)for(const e of n.segments)t+=e.points.length;return t}function Kt(s,t){const n=Number.isFinite(t.start)?t.start:0,e=Number.isFinite(t.end)?t.end:1/0;let i=0;const o=s.tracks.map(p=>{const r=p.segments.map(a=>({points:a.points.filter(()=>{const c=i>=n&&i<=e;return i++,c})})).filter(a=>a.points.length>0);return{...p,segments:r}}).filter(p=>p.segments.length>0);return{...s,tracks:o}}function dt(s){let t=null;for(const n of s.tracks)for(const e of n.segments)t=R(t,$(e.points));for(const n of s.routes)t=R(t,$(n.points));return t=R(t,$(s.waypoints)),t}function Qt(s,t){const n=I(s),e=ft(n);let i=n;t.merge&&(i=Mt(i,{})),t.trimRange&&(i=Kt(i,t.trimRange));let o=0;if(t.privacyZone){const c=Rt(i,t.privacyZone,t.privacyMode);i=c.doc,o=c.removed}t.simplifyToleranceM&&t.simplifyToleranceM>0&&(i=Jt(i,t.simplifyToleranceM)),t.fuzzDecimals!==null&&(i=Dt(i,t.fuzzDecimals)),i=Nt(i,t.strip);const p=U(n),r=U(i),a={pointsBefore:G(n),pointsAfter:G(i),pointsRemoved:G(n)-G(i),bytesBefore:lt(p),bytesAfter:lt(r),bboxBefore:dt(n),bboxAfter:dt(i),removedTimestamps:t.strip.time&&e.hasTime,removedExtensions:t.strip.extensions&&e.hasExtensions,removedElevation:t.strip.elevation&&e.hasElevation,removedNames:t.strip.names&&e.hasNames,removedCreator:t.strip.creator&&e.hasCreator,fuzzedTo:t.fuzzDecimals,privacyZoneApplied:t.privacyZone,privacyZonePointsRemoved:o,notes:[]},x=[];return a.privacyZoneApplied&&x.push(`Privacy zone (${a.privacyZoneApplied.radiusM} m) removed ${o} point(s) near the centre.`),a.removedTimestamps&&x.push("Removed all timestamps."),a.removedExtensions&&x.push("Removed sensor/extension data (heart rate, cadence, power, accuracy…)."),a.removedElevation&&x.push("Removed elevation data."),a.removedNames&&x.push("Removed names, comments and descriptions."),a.removedCreator&&x.push("Removed creator/device and author metadata."),a.fuzzedTo!==null&&x.push(`Rounded coordinates to ${a.fuzzedTo} decimal place(s).`),t.simplifyToleranceM&&t.simplifyToleranceM>0&&x.push(`Simplified geometry at ${t.simplifyToleranceM} m tolerance.`),t.trimRange&&x.push("Trimmed the track to the selected range."),t.merge&&x.push("Merged all tracks into one."),x.length===0&&x.push("No edits applied yet — the output equals the input."),tn(x,n,i),a.notes=x,{source:n,result:i,report:a}}function tn(s,t,n){const e=gt(t),i=gt(n);e!==i&&s.push(`Track points: ${e.toLocaleString()} → ${i.toLocaleString()}.`)}function nn(){return{time:!1,extensions:!1,elevation:!1,names:!1,creator:!1}}function X(){return{privacyZone:null,privacyMode:"crop-ends",strip:nn(),fuzzDecimals:null,trimRange:null,simplifyToleranceM:null,merge:!1}}function en(s){let t=0;for(const n of s.tracks)for(const e of n.segments)t+=e.points.length;return t}class sn{files=[];config=X();units="metric";status="empty";errorMessage=null;zonePickMode=!1;listeners=new Set;derivedCache=null;subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}emit(){this.derivedCache=null;for(const t of this.listeners)t(this)}get docs(){return this.files.map(t=>t.doc)}get derived(){if(this.derivedCache)return this.derivedCache;const t=I(this.docs),n=Qt(this.docs,this.config),e={transform:n,sourceStats:ct(t),resultStats:ct(n.result),trimMax:Math.max(0,en(t)-1),inventory:ft(t)};return this.derivedCache=e,e}get trackCount(){return this.docs.reduce((t,n)=>t+n.tracks.length,0)}addFiles(t){t.length!==0&&(this.files.push(...t),this.status="ready",this.errorMessage=null,this.config=X(),this.zonePickMode=!1,this.emit())}removeFile(t){this.files.splice(t,1),this.files.length===0&&(this.status="empty"),this.config=X(),this.emit()}reset(){this.files=[],this.config=X(),this.status="empty",this.errorMessage=null,this.zonePickMode=!1,this.emit()}setError(t){this.errorMessage=t,this.files.length===0&&(this.status="error"),this.emit()}clearError(){this.errorMessage&&(this.errorMessage=null,this.files.length===0&&(this.status="empty"),this.emit())}patchConfig(t){this.config={...this.config,...t},this.emit()}patchStrip(t){this.config={...this.config,strip:{...this.config.strip,...t}},this.emit()}setUnits(t){this.units=t,this.emit()}setZonePickMode(t){this.zonePickMode=t,this.emit()}}const on=`<?xml version="1.0" encoding="UTF-8"?>
...
`;function pn(s){return new Promise((t,n)=>{const e=new FileReader;e.onload=()=>t(String(e.result??"")),e.onerror=()=>n(e.error??new Error("Could not read file")),e.readAsText(s)})}const rn=60*1024*1024;async function xn(s){const t=Array.from(s),n=[],e=[];for(const o of t){if(o.size>rn){e.push(`${o.name}: file is too large (${(o.size/1024/1024).toFixed(0)} MB).`);continue}!o.name.toLowerCase().endsWith(".gpx")&&o.type!=="application/gpx+xml"&&e.push(`${o.name}: not a .gpx file; attempting to parse anyway.`);try{const r=await pn(o),a=ut(r,o.name);a.ok?n.push({name:o.name,doc:a.doc}):e.push(`${o.name}: ${a.error}`)}catch(r){e.push(`${o.name}: ${r.message}`)}}const i=new Set(n.map(o=>o.name));return{loaded:n,errors:e.filter(o=>!i.has(o.split(":")[0]))}}function Tt(s,t="pasted.gpx"){const n=ut(s,t);return n.ok?{loaded:[{name:t,doc:n.doc}],errors:[]}:{loaded:[],errors:[`${t}: ${n.error}`]}}function an(){return Tt(on,"sample-morning-loop.gpx")}const w={source:"rgba(148,163,184,0.35)",result:"#38bdf8",ring:"#f59e0b",ringFill:"rgba(245,158,11,0.12)",removed:"#f43f5e",start:"#22c55e",end:"#f43f5e",waypoint:"#f59e0b",grid:"rgba(148,163,184,0.08)"};function N(s){const t=[];for(const n of s.tracks)for(const e of n.segments)e.points.length&&t.push(e.points);for(const n of s.routes)n.points.length&&t.push(n.points);return t}class cn{canvas;ctx;dpr=Math.max(1,window.devicePixelRatio||1);source=null;result=null;zone=null;pickMode=!1;originLat=0;baseScale=1;dataCenter={x:0,y:0};zoom=1;panX=0;panY=0;dragging=!1;moved=!1;lastX=0;lastY=0;onPickCenter=null;constructor(t){this.canvas=document.createElement("canvas"),this.canvas.className="block size-full touch-none",this.canvas.setAttribute("role","img"),this.canvas.setAttribute("aria-label","Map preview of the GPS track (rendered locally)"),t.appendChild(this.canvas);const n=this.canvas.getContext("2d");if(!n)throw new Error("Canvas 2D context unavailable");this.ctx=n,new ResizeObserver(()=>this.resize()).observe(t),this.canvas.addEventListener("pointerdown",this.onPointerDown),this.canvas.addEventListener("pointermove",this.onPointerMove),this.canvas.addEventListener("pointerup",this.onPointerUp),this.canvas.addEventListener("pointerleave",this.onPointerUp),this.canvas.addEventListener("wheel",this.onWheel,{passive:!1}),this.resize()}get cssW(){return this.canvas.clientWidth||1}get cssH(){return this.canvas.clientHeight||1}resize=()=>{this.canvas.width=Math.round(this.cssW*this.dpr),this.canvas.height=Math.round(this.cssH*this.dpr),this.draw()};setData(t,n,e){const i=t!==this.source;this.source=t,this.result=n,this.zone=e,i&&t&&(this.computeProjection(t),this.fitView()),this.draw()}setPickMode(t){this.pickMode=t,this.canvas.style.cursor=t?"crosshair":"grab"}computeProjection(t){let n=null;for(const a of N(t))n=R(n,$(a));n=R(n,$(t.waypoints)),n||(n={minLat:0,minLon:0,maxLat:0,maxLon:0}),this.originLat=(n.minLat+n.maxLat)/2;const e=O(n.minLat,n.minLon,this.originLat),i=O(n.maxLat,n.maxLon,this.originLat);this.dataCenter={x:(e.x+i.x)/2,y:(e.y+i.y)/2};const o=Math.max(1,Math.abs(i.x-e.x)),p=Math.max(1,Math.abs(i.y-e.y)),r=.86;this.baseScale=Math.min(this.cssW*r/o,this.cssH*r/p),(!Number.isFinite(this.baseScale)||this.baseScale<=0)&&(this.baseScale=1)}fitView(){this.zoom=1,this.panX=0,this.panY=0,this.draw()}invalidateSize(){this.source&&this.computeProjection(this.source),this.resize()}zoomBy(t){this.zoom=Math.min(200,Math.max(.2,this.zoom*t)),this.draw()}scale(){return this.baseScale*this.zoom}project(t){const n=O(t.lat,t.lon,this.originLat),e=this.scale();return{x:this.cssW/2+(n.x-this.dataCenter.x)*e+this.panX,y:this.cssH/2-(n.y-this.dataCenter.y)*e+this.panY}}unproject(t,n){const e=this.scale(),i=(t-this.cssW/2-this.panX)/e+this.dataCenter.x,o=-(n-this.cssH/2-this.panY)/e+this.dataCenter.y,p=63710088e-1,r=Math.PI/180,a=o/(r*p),x=i/(r*p*Math.cos(this.originLat*r));return{lat:a,lon:x}}onPointerDown=t=>{this.dragging=!0,this.moved=!1,this.lastX=t.clientX,this.lastY=t.clientY,this.canvas.setPointerCapture(t.pointerId),this.pickMode||(this.canvas.style.cursor="grabbing")};onPointerMove=t=>{if(!this.dragging)return;const n=t.clientX-this.lastX,e=t.clientY-this.lastY;Math.abs(n)+Math.abs(e)>3&&(this.moved=!0),this.pickMode||(this.panX+=n,this.panY+=e,this.draw()),this.lastX=t.clientX,this.lastY=t.clientY};onPointerUp=t=>{if(this.dragging&&this.pickMode&&!this.moved){const n=this.canvas.getBoundingClientRect(),{lat:e,lon:i}=this.unproject(t.clientX-n.left,t.clientY-n.top);this.onPickCenter?.(e,i)}this.dragging=!1,this.pickMode||(this.canvas.style.cursor="grab")};onWheel=t=>{t.preventDefault(),this.zoomBy(t.deltaY<0?1.12:1/1.12)};draw(){const t=this.ctx;if(t.save(),t.scale(this.dpr,this.dpr),t.clearRect(0,0,this.cssW,this.cssH),this.drawGrid(),!this.source){t.restore();return}this.drawRuns(N(this.source),w.source,1.5),this.zone&&this.drawZone(this.zone),this.result&&this.drawRuns(N(this.result),w.result,2.5),this.zone&&this.drawRemovedPoints(this.source,this.zone),this.result&&this.drawEndpoints(this.result),this.drawWaypoints(this.source),this.drawScaleBar(),t.restore()}drawGrid(){const t=this.ctx;t.strokeStyle=w.grid,t.lineWidth=1;const n=40;t.beginPath();for(let e=0;e<this.cssW;e+=n)t.moveTo(e,0),t.lineTo(e,this.cssH);for(let e=0;e<this.cssH;e+=n)t.moveTo(0,e),t.lineTo(this.cssW,e);t.stroke()}drawRuns(t,n,e){const i=this.ctx;i.strokeStyle=n,i.lineWidth=e,i.lineJoin="round",i.lineCap="round";for(const o of t)i.beginPath(),o.forEach((p,r)=>{const a=this.project(p);r===0?i.moveTo(a.x,a.y):i.lineTo(a.x,a.y)}),i.stroke()}drawZone(t){const n=this.ctx,e=this.project({lat:t.lat,lon:t.lon}),i=t.radiusM*this.scale();n.beginPath(),n.arc(e.x,e.y,Math.max(2,i),0,Math.PI*2),n.fillStyle=w.ringFill,n.fill(),n.strokeStyle=w.ring,n.lineWidth=1.5,n.setLineDash([6,4]),n.stroke(),n.setLineDash([]),n.strokeStyle=w.ring,n.beginPath(),n.moveTo(e.x-6,e.y),n.lineTo(e.x+6,e.y),n.moveTo(e.x,e.y-6),n.lineTo(e.x,e.y+6),n.stroke()}drawRemovedPoints(t,n){const e=this.ctx;e.fillStyle=w.removed;for(const i of N(t))for(const o of i)if(F(o,n)){const p=this.project(o);e.beginPath(),e.arc(p.x,p.y,2.2,0,Math.PI*2),e.fill()}}drawEndpoints(t){const n=N(t);if(n.length===0)return;const e=n[0][0],i=n[n.length-1],o=i[i.length-1];this.marker(this.project(e),w.start),this.marker(this.project(o),w.end)}drawWaypoints(t){for(const n of t.waypoints)this.marker(this.project(n),w.waypoint,3.5)}marker(t,n,e=5){const i=this.ctx;i.beginPath(),i.arc(t.x,t.y,e,0,Math.PI*2),i.fillStyle=n,i.fill(),i.lineWidth=2,i.strokeStyle="#0f172a",i.stroke()}drawScaleBar(){const t=this.ctx,n=this.scale();if(!Number.isFinite(n)||n<=0)return;const i=80/n,o=[1,2,5,10,20,50,100,200,500,1e3,2e3,5e3,1e4];let p=o[o.length-1];for(const d of o)if(d>=i){p=d;break}const r=p*n,a=16,x=this.cssH-18;t.strokeStyle="rgba(248,250,252,0.8)",t.lineWidth=2,t.beginPath(),t.moveTo(a,x),t.lineTo(a+r,x),t.moveTo(a,x-4),t.lineTo(a,x+4),t.moveTo(a+r,x-4),t.lineTo(a+r,x+4),t.stroke(),t.fillStyle="rgba(248,250,252,0.85)",t.font='11px "JetBrains Mono", monospace';const c=p>=1e3?`${p/1e3} km`:`${p} m`;t.fillText(c,a,x-8)}}class ln{constructor(t){this.cb=t,this.root=document.createElement("div"),this.root.className="mx-auto w-full max-w-3xl px-4 py-10 sm:py-16",this.root.innerHTML=`
      ...
      <div data-ref="drop" tabindex="0" role="button" aria-label="Drop a GPX file or click to choose one"
        ...
        <div class="flex flex-col items-center justify-center gap-3 px-6 py-12 text-center">
          <span class="text-accent">${h("upload","size-8")}</span>
      ...
      <div class="mt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
        <button data-ref="sample" class="btn-ghost text-sm">${h("route","size-4")} Try it with a sample track</button>
        <button data-ref="paste-toggle" class="btn-ghost text-sm">${h("copy","size-4")} Paste GPX text</button>
      </div>
      ...
      <div data-ref="paste-box" class="mt-4 hidden">
        ...
        <div class="mt-2 text-right">
          <button data-ref="paste-load" class="btn-primary text-sm">${h("check","size-4")} Load pasted GPX</button>
        </div>
      </div>

      <div class="mt-10 grid sm:grid-cols-2 gap-3">
        <div class="card p-4 space-y-2">
          <div class="flex items-center gap-2 text-fg"><span class="text-accent">${h("wifi-off","size-4")}</span><h3 class="text-sm font-semibold">100% offline</h3></div>
        ...
        <div class="card p-4 space-y-2">
          <div class="flex items-center gap-2 text-fg"><span class="text-accent">${h("eye","size-4")}</span><h3 class="text-sm font-semibold">What it removes</h3></div>
    ...
    <span data-ref="${s}-badge" class="data shrink-0 rounded px-1.5 py-0.5 text-[11px] font-medium"></span>
         ...
         <div data-ref="zone-body" class="space-y-3 hidden">
           <div class="flex gap-2">
             <button data-ref="zone-auto" class="btn-ghost flex-1 text-xs">${h("crosshair","size-3.5")} Auto-detect home</button>
             <button data-ref="zone-pick" class="btn-ghost flex-1 text-xs">${h("map-pin","size-3.5")} <span data-ref="zone-pick-label">Pick on map</span></button>
           </div>
      ...
      <section class="card p-4 space-y-3">
        <header class="flex items-center gap-2 text-fg">
          <span class="text-accent">${h("download","size-4")}</span>
          <h2 class="text-sm font-semibold">Export cleaned track</h2>
        </header>
        <div class="grid grid-cols-3 gap-2">
          <button data-ref="exp-gpx" class="btn-primary text-xs">${h("download","size-3.5")} GPX</button>
        ...
        <button data-ref="exp-copy" class="btn-ghost w-full text-xs">${h("copy","size-3.5")} <span data-ref="copy-label">Copy GPX to clipboard</span></button>
      </section>

      <section class="card p-4 space-y-3">
        <header class="flex items-center justify-between">
          <div class="flex items-center gap-2 text-fg"><span class="text-accent">${h("activity","size-4")}</span><h2 class="text-sm font-semibold">Statistics</h2></div>
    ...
    </div>`}update(){const t=this.store,{report:n}=t.derived.transform,e=t.units;this.ref("unit-metric").className=`px-2 py-1 ${e==="metric"?"bg-accent text-on-accent":"text-fg-muted"}`,this.ref("unit-imperial").className=`px-2 py-1 border-l border-border-soft ${e==="imperial"?"bg-accent text-on-accent":"text-fg-muted"}`;const o=[[n.privacyZoneApplied!==null&&n.privacyZonePointsRemoved>0,"Home/privacy zone cropped"],[n.removedTimestamps,"Timestamps removed"],[n.removedExtensions,"Sensor data removed"],[n.removedElevation,"Elevation removed"],[n.removedNames,"Names & notes removed"],[n.removedCreator,"Device & author removed"],[n.fuzzedTo!==null,`Coordinates rounded to ${n.fuzzedTo} dp`]].filter(([d])=>d),p=o.length>0,r=p?`<div class="flex items-center gap-2 rounded-control bg-accent/10 border border-accent/30 px-3 py-2 text-accent text-sm">${h("shield-check","size-4")}<span>${o.length} privacy action(s) applied — ready to share.</span></div>`:`<div class="flex items-center gap-2 rounded-control bg-surface-2 border border-border-soft px-3 py-2 text-fg-muted text-sm">${h("shield","size-4")}<span>No personal data removed yet. Turn on the controls at left.</span></div>`,a=o.map(([,d])=>`<li class="flex items-center gap-2 text-sm text-fg"><span class="text-accent">${h("check","size-3.5")}</span>${d}</li>`).join(""),x=n.bytesBefore>0?`${B(n.bytesBefore)} → ${B(n.bytesAfter)} (${bt(n.bytesBefore,n.bytesAfter)} smaller)`:B(n.bytesAfter);this.ref("report-body").innerHTML=`
      ${r}
      ${p?`<ul class="space-y-1">${a}</ul>`:""}
      <div class="pt-1">
        ${this.row("Points",`${P(n.pointsBefore)} → ${P(n.pointsAfter)}`,n.pointsRemoved>0)}
        ${this.row("Removed",`${P(n.pointsRemoved)}`,n.pointsRemoved>0)}
        ${this.row("File size",x)}
      ...
      ${this.row("Elevation gain",c.maxEleM!==null?j(c.elevationGainM,e):"—")}
      ${this.row("Elevation loss",c.maxEleM!==null?j(c.elevationLossM,e):"—")}
      ${this.row("Min / max elev.",c.minEleM!==null&&c.maxEleM!==null?`${j(c.minEleM,e)} / ${j(c.maxEleM,e)}`:"—")}
      ...
      <header class="sticky top-0 z-20 border-b border-border-soft bg-bg/90 backdrop-blur supports-[backdrop-filter]:bg-bg/70">
        ...
        <div class="mx-auto max-w-[1500px] px-4 h-14 flex items-center gap-3">
          <div class="flex items-center gap-2 text-fg">
            <span class="text-accent">${h("shield-check","size-6")}</span>
          ...
          <span class="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-accent/30 bg-accent/10 px-2.5 py-1 text-xs text-accent">
            ${h("wifi-off","size-3.5")} Offline · nothing uploaded
          </span>
      ...
      <main class="flex-1">
        <div data-ref="error" role="alert" class="hidden border-b border-danger/30 bg-danger/10">
          <div class="mx-auto max-w-[1500px] px-4 py-2.5 flex items-start gap-2 text-sm text-danger">
            <span class="mt-0.5 shrink-0">${h("alert-triangle","size-4")}</span>
            <p data-ref="error-text" class="flex-1"></p>
            <button data-ref="error-close" class="shrink-0 text-danger/80 hover:text-danger" aria-label="Dismiss">${h("x","size-4")}</button>
          </div>
        </div>
          ...
          <div class="grid gap-4 grid-cols-1 lg:grid-cols-[320px_minmax(0,1fr)_360px] lg:h-[calc(100dvh-128px)]">
            ...
            <section class="order-1 lg:order-2 relative h-[52vh] lg:h-full rounded-card border border-border-soft bg-surface overflow-hidden" data-ref="canvas-host">
              <div class="absolute right-3 top-3 z-10 flex flex-col gap-1.5">
                <button data-ref="zoom-in" class="btn-ghost size-9 !p-0" aria-label="Zoom in">${h("zoom-in","size-4")}</button>
                <button data-ref="zoom-out" class="btn-ghost size-9 !p-0" aria-label="Zoom out">${h("zoom-out","size-4")}</button>
                <button data-ref="zoom-fit" class="btn-ghost size-9 !p-0" aria-label="Fit to view">${h("crosshair","size-4")}</button>
              </div>
    ...
    </div>`;const n=g=>s.querySelector(`[data-ref="${g}"]`);async function e(g){const{loaded:m,errors:f}=await xn(g);m.length&&t.addFiles(m),f.length&&t.setError(f.join(" "))}function i(g){const{loaded:m,errors:f}=Tt(g);m.length?t.addFiles(m):t.setError(f.join(" "))}function o(){const{loaded:g}=an();t.addFiles(g)}const p=new ln({onFiles:e,onSample:o,onPaste:i});n("empty").appendChild(p.root);const r=new gn(t);n("controls-host").appendChild(r.root);const a=new un(t);n("report-host").appendChild(a.root);const x=new cn(n("canvas-host"));x.onPickCenter=(g,m)=>{const f=t.config.privacyZone;f&&t.patchConfig({privacyZone:{...f,lat:g,lon:m}}),t.setZonePickMode(!1)},n("zoom-in").addEventListener("click",()=>x.zoomBy(1.3)),n("zoom-out").addEventListener("click",()=>x.zoomBy(1/1.3)),n("zoom-fit").addEventListener("click",()=>x.fitView()),n("header-actions").innerHTML=`
    <input data-ref="hdr-file" type="file" accept=".gpx,application/gpx+xml" multiple class="hidden" />
    <button data-ref="hdr-add" class="btn-ghost text-xs hidden">${h("upload","size-3.5")} <span class="hidden sm:inline">Add files</span></button>
    <button data-ref="hdr-reset" class="btn-ghost text-xs hidden">${h("rotate-ccw","size-3.5")} <span class="hidden sm:inline">Reset</span></button>`;const c=n("hdr-file");n("hdr-add").addEventListener("click",()=>c.click()),c.addEventListener("change",()=>{c.files?.length&&e(c.files),c.value=""}),n("hdr-reset").addEventListener("click",()=>t.reset()),n("error-close").addEventListener("click",()=>t.clearError()),s.addEventListener("dragover",g=>{t.files.length&&g.preventDefault()}),s.addEventListener("drop",g=>{t.files.length&&g.dataTransfer?.files?.length&&(g.preventDefault(),e(g.dataTransfer.files))});const d=`
    ...
    <div class="flex items-center gap-1.5 text-fg-muted"><span class="inline-block size-2 rounded-full bg-accent"></span> start <span class="inline-block size-2 rounded-full ml-1 bg-danger"></span> end</div>`;function l(){const g=t.files.length>0;n("empty").classList.toggle("hidden",g),n("workspace").classList.toggle("hidden",!g),n("hdr-add").classList.toggle("hidden",!g),n("hdr-reset").classList.toggle("hidden",!g);const m=n("error");if(t.errorMessage?(m.classList.remove("hidden"),n("error-text").textContent=t.errorMessage):m.classList.add("hidden"),g){const f=t.derived.sourceStats.total.pointCount;n("chips").innerHTML=t.files.map((E,z)=>`<span class="inline-flex items-center gap-1.5 rounded-full bg-surface border border-border-soft px-2.5 py-1 text-xs text-fg">${h("file","size-3.5")}<span class="max-w-[180px] truncate">${_(E.name)}</span><button data-remove="${z}" class="text-fg-muted hover:text-danger" aria-label="Remove ${_(E.name)}">${h("x","size-3.5")}</button></span>`).join("")+`<span class="text-xs text-fg-muted ml-1 data">${P(f)} points loaded</span>`,n("chips").querySelectorAll("[data-remove]").forEach(E=>E.addEventListener("click",()=>t.removeFile(Number(E.dataset.remove)))),n("legend").innerHTML=d,x.invalidateSize();const{source:k,result:M}=t.derived.transform;x.setData(k,M,t.config.privacyZone),x.setPickMode(t.zonePickMode),r.update(),a.update()}}t.subscribe(l),l()}const mt=document.querySelector("#app");mt&&kn(mt);
